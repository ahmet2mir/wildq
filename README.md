...
* an example of INI manipulation made by AWS ParallelCluster Workshop [(workshop)](https://containers-on-pcluster.workshop.aws/setup/pcluster.html) [(example 2)](https://containers-on-pcluster.workshop.aws/setup/pcluster/pcluster-cfg/refine.html) [(example 3)](https://containers-on-pcluster.workshop.aws/setup/pcluster/pcluster-cnt/create-x86.html)
